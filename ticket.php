...
$create = json_encode(array('ticket' => array('subject' => $arr['z_subject'], 'product' => $arr['z_31204387'], 'comment' => array( "value"=> $arr['z_description']), 'requester' => array('name' => $arr['z_name'], 'email' => $arr['z_requester']))));
