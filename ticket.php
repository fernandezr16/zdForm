...
$create = json_encode(array('ticket' => array('subject' => $arr['z_subject'], array('custom_fields' => '31204387'), 'comment' => array( "value"=> $arr['z_description']), 'requester' => array('name' => $arr['z_name'], 'email' => $arr['z_requester']))));
